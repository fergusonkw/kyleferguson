...
return [
    ...
    'browsershot' => [
        ...
        /*
         * Browsershot shells out to Puppeteer, which must be able to find the
         * project's node_modules. Defaulting to the app's own directory means
         * invoice rendering works on a fresh checkout with no env setup; the
         * env var is there for hosts that install node_modules elsewhere.
         */
